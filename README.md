...
- **Discover** — `list_board` (Home Kanban; Linear Backlog defaults to your current cycle), `list_workspaces` (path + GitHub slug), `list_branches` / `list_prs` / `list_issues` (Linear or GitHub), `list_threads`
