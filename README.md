...
| Panel | What |
|-------|------|
| **Agents** | Default agent, model, and effort; your roles (check one or more of Engineering, Design, Product) for ticket and PR recommendations; then harness setup (Claude, Codex, OpenCode, Cursor, Brightsy) |
