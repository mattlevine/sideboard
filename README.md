...
- **Discover** — `list_board` (worktree Kanban: In Process → Review → Done; `create_thread` adds a worktree), `list_workspaces` (path + GitHub slug), `list_branches` / `list_prs` / `list_issues` (Linear or GitHub), `list_threads`
