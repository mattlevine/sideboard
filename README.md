...
![Sideboard desktop — Review chat with HTML artifact preview, worktree files, and PR status](docs/assets/sideboard-desktop-review-v3.png)
...
| Chip | DMG |
|------|-----|
| Apple Silicon | https://github.com/mattlevine/sideboard/releases/download/v0.1.51/Sideboard-0.1.51-arm64.dmg |
| Intel | https://github.com/mattlevine/sideboard/releases/download/v0.1.51/Sideboard-0.1.51.dmg |
