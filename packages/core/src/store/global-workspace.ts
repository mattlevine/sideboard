...
export function slackCoordinatorSourceRef(teamId: string, userId: string): string {
...
export function isSlackCoordinatorThread(
  thread: Pick<Thread, 'sourceType' | 'sourceRef' | 'repoPath'>,
): boolean {
