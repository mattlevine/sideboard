...
export const COORDINATOR_TOOL_PLAYBOOK = [
  ...
  '- list_board — Home Kanban (Backlog / Queued / Running / Needs you / Review / Done). Same cards as desktop Home. Filters: query, repoPath, kind (all|tickets|prs|threads), column, limit. Prefer this for ticket-to-worktree status.',
